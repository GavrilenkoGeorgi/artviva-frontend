...
const getPostsURL = ( access_token ) => {
	// eslint-disable-next-line
	return `https://graph.facebook.com/v17.0/${process.env.REACT_APP_FACEBOOK_PAGE_ID}/feed?fields=message,full_picture,created_time,permalink_url&access_token=${access_token}`
}
