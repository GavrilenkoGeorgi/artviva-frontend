...
const Oferta = () => {
	...
	return <CommonLayout>
		<Container className="oferta-container">
			...
			<p>
				<strong>Комунальний заклад спеціалізованої мистецкої освіти «Школа мистецтв «АРТ ВІВА»
			...
			<p>
				1.6. КЗСМО – комунальний заклад спеціалізованої мистецкої освіти.</p>
			<p>
			...
			<p>
				12.3. Виконавець за цим договором є: <strong>Комунальний заклад спеціалізованої мистецкої
					освіти «Школа мистецтв «АРТ ВІВА» Києво-Святошинської районної
